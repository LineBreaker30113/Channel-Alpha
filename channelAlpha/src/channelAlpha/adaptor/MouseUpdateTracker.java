...
public class MouseUpdateTracker implements MouseListener, MouseWheelListener {
	public Date leftLastPressDate = null, rightLastPressDate = null, middleLastPress = null;
	public Date leftLastReleaseDate = null, rightLastReleaseDate = null, middleLastRelease = null;
	...
	public MouseUpdateTracker(Component component) {
		...
		leftLastPressDate = new Date(); rightLastPressDate = new Date(); middleLastPress = new Date();
		leftLastReleaseDate = new Date(); rightLastReleaseDate = new Date(); middleLastRelease = new Date();
	}

	public channelAlpha.lang.Point2i leftLastPressPosition = null, leftLastReleasePosition = null;
	public channelAlpha.lang.Point2i rightLastPressPosition = null, rightLastReleasePosition = null;
	public int leftSameFor = 0, rightSameFor = 0;
	public double wheelStatus = 0;
	public Component mouseOriginObject = null;
	public channelAlpha.lang.Point2i position = new channelAlpha.lang.Point2i();
	public void onPress(MouseEvent e) {
		switch(e.getButton()) {
		case MouseEvent.BUTTON2: midle = true; break;
		case MouseEvent.BUTTON1:
			left = true; leftSameFor = 0;
			leftLastPressPosition = new channelAlpha.lang.Point2i(e.getX(), e.getY());
			leftLastPressDate = new Date();
			break;
		case MouseEvent.BUTTON3:
			right = true; rightSameFor = 0;
			rightLastPressPosition = new channelAlpha.lang.Point2i(e.getX(), e.getY());
			rightLastPressDate = new Date();
			break;
		}
	}
	public void onRelease(MouseEvent e) {
		...
		case MouseEvent.BUTTON1:
			...
			leftLastReleasePosition = new channelAlpha.lang.Point2i(e.getX(), e.getY());
			leftLastReleaseDate = new Date();
			break;
		case MouseEvent.BUTTON3:
			right = false; rightSameFor = 0; rightReaded = false;
			rightLastReleasePosition = new channelAlpha.lang.Point2i(e.getX(), e.getY());
			leftLastReleaseDate = new Date();
			break;
		}
	}
	...
	public channelAlpha.lang.Point2i getPosition() {
		Point p = MouseInfo.getPointerInfo().getLocation();
		return new channelAlpha.lang.Point2i(p.x, p.y);
	}
	public channelAlpha.lang.Point2i getRelativePosition() {
		Point p = component.getLocationOnScreen(); channelAlpha.lang.Point2i r = getPosition();
		r.x -= p.x; r.y -= p.y;
		return r;
	}
	public channelAlpha.lang.Point2i getPosition(Component relative) {
		Point p = relative.getLocationOnScreen(); channelAlpha.lang.Point2i r = getPosition();
		r.x -= p.x; r.y -= p.y;
		return r;
	}
